          ...
          <div>
            <FadeIn>
              <div className="mb-6 flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-2 rounded-full border border-brand-100 bg-brand-50/80 px-4 py-1.5 text-sm font-medium text-brand-700">
                  ...
                  Pre-launch · Trade Operating System
                </span>
            ...
            <FadeIn delay={0.1}>
              <h1 className="text-4xl sm:text-5xl lg:text-[3.25rem] font-bold tracking-tight text-slate-900 text-balance leading-[1.1]">
                One platform for customs, freight, documents, and{" "}
                <span className="gradient-text">trade intelligence</span>
              </h1>
            </FadeIn>

            <FadeIn delay={0.2}>
              <p className="mt-6 text-lg text-slate-600 leading-relaxed text-balance">
                ExportGateway connects AI-powered CN classification, historical customs evidence,
                EU freight pricing, export documentation, and an intelligent trade assistant —
            ...
            <FadeIn delay={0.3}>
              <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <Button variant="secondary" href="/platform/customs" size="lg">
            ...
            <FadeIn delay={0.4}>
              <p className="mt-6 text-sm text-slate-400">
                Compliance Wizard is Live · {formatMetricPlus(PLATFORM_METRICS.exportDeclarationsAnalysed)} export
          ...
          <FadeIn delay={0.3} className="relative">
            ...
            <div className="relative rounded-2xl border border-surface-border bg-white p-6 sm:p-8 shadow-xl shadow-brand-500/5">
              ...
              <div className="mt-4 rounded-lg bg-surface-dark p-4">
                <p className="text-[10px] text-slate-500 uppercase tracking-wider">Central Shipment</p>
                <p className="text-sm font-medium text-white mt-1">Unified trade workspace</p>
